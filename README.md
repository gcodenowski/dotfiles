...
| sketchybar-system-stats | Event provider for SketchyBar | https://github.com/joncrangle/sketchybar-system-stats |
...
- SIP (System Integrity Protection) **doesn't** need to be disabled for yabai to work.

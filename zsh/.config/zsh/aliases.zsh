...
alias yabaiconfig='cd "$HOME/dotfiles/yabai/.config/yabai"'
alias kittyconfig='cd "$HOME/dotfiles/kitty/.config/kitty"'
alias fastfetchconfig='cd "$HOME/dotfiles/fastfetch/.config/fastfetch"'
alias sketchybarconfig='cd "$HOME/dotfiles/sketchybar/.config/sketchybar"'
alias nvimconfig='cd "$HOME/dotfiles/nvim/.config/nvim"'
alias neovimconfig='cd "$HOME/dotfiles/nvim/.config/nvim"'
alias opencodeconfig='cd "$HOME/dotfiles/opencode/.config/opencode/"'
...
alias programming='cd "$HOME/Code"'
